  ...
  const projects = [
    {
      ...
      description:
        "Full-featured Doctor appointment scheduler to manage all appointment digitally by the doctor.",
    ...
    },
    {
      ...
      description:
        "Result viewing portla where student can view result list of their centers.",
